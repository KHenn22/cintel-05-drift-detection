"""
hennelly_drift_detector.py - Project script (example).
...
Paths (relative to repo root)
    ...
    OUTPUT FILE: artifacts/drift_summary_hennelly.csv

Terminal command to run this file from the root project folder

    uv run python -m cintel.hennelly_drift_detector
...
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_hennelly.csv"
SUMMARY_LONG_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_long_hennelly.csv"
